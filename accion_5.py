class accion_5:
    ...
    def dibujar (self,intervalos):
        ...
        for i in range (max_valor):         
            ...
            print ("\033["+"7;30;45"+"m "+ " ".center(espacio_inter," ") +" "+linea_contructura+" ".center(espacio_inter+1,"\u2800")+"\033[0m")
        print ("\033["+"7;30;45"+"m "+" ".center(espacio_inter," ")+("\u2501")+(("\u2501")+('\u2501')+('\u2501'))*(len(lista_acomodar))+" ".center(espacio_inter-1," ")+"\033[0m")
        for i in range (len(lista_con_intervalos)):
            lista_con_intervalos[i]=str(lista_con_intervalos[i]).center(espacio_inter+1,"\u2800")
        linea_intervalos= ("  ") .join (lista_con_intervalos)

        print ("\033["+"7;30;45"+"m"+" ".center(espacio+1,"\u2800")+linea_intervalos+" ".center(espacio-1,"\u2800")+"\033[0m")
...
ejecutar_5 = accion_5()
intervalos = [['1',2,1,3,4,5,14],['1',4,1,45,89,456,1234],['1',5,1,45,89,456,1234],['1',4,4,45,89,456,1234],['1',5,1,45,89,456,1234],['1',5,1,45,89,456,1234]]
